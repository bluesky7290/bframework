module core {
    export class EffectUtils {
         ...
         */
        public static macIconShake(obj: egret.DisplayObject, initY: number): void {
            //抖动频率[时间，移动距离]，可修改
            var arr: Array<any> = [
                [20, 300],
                [15, 300],
         ...
         * @param obj
         */
        public static startScale(obj: egret.DisplayObject, scaleTime: number): void {
            obj.scaleX = 1;
            obj.scaleY = 1;
            egret.Tween.get(obj)
         ...
         * @param obj
         */
        public static stopScale(obj: egret.DisplayObject): void {
         ...
         * @param obj
         */
        public static startFlicker(obj: egret.DisplayObject, alphaTime: number, alpha_min: number = 0): void {
            obj.alpha = 1;
         ...
         * 设置显示对象“黑化”效果
         */
        public static setDisplayObjectBlack(obj: egret.DisplayObject): void {
            //颜色矩阵数组
            let colorMatrix = [
                1, 0, 0, 0, -255,
                0, 1, 0, 0, -255,
         ...
         * 设置显示对象“灰化”效果
         */
        public static setDisplayObjectGray(obj: egret.DisplayObject): void {
            //颜色矩阵数组
            let colorMatrix = [
                0.3, 0.6, 0, 0, 0,
                0.3, 0.6, 0, 0, 0,
         ...
         * @param obj
         */
        public static startWobble(obj: egret.DisplayObject, wobbleTime: number = 100, wobbleRotation: number = 20): void {
            egret.Tween.get(obj)
         ...
         * @param obj
         */
        public static stopWobble(obj: egret.DisplayObject): void {
            obj.rotation = 0;
            egret.Tween.removeTweens(obj);
        }
        /**
