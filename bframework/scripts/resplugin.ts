...
export class ResPlugin implements plugins.Command {
    ...
    async onFile(file: plugins.File) {
        ...
        if (path.indexOf(this.versionPath) != -1 && (file.extname === ".mp3" || file.extname === ".fnt" || file.extname === ".json" || file.extname === ".png" || file.extname === ".jpg" || file.extname === ".zip" || file.extname === ".dbbin")) {
